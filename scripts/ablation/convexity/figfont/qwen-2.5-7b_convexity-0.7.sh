...
experiment_name=qwen-2.5-7b-lr-$lr-bz-$bz-max_length-$max_length-nproc_per_node-$nproc_per_node-micro_batch_size-$micro_batch_size-weight_decay-$weight_decay-0916-convexity-0.7
