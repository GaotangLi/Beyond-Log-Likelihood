...
experiment_name=numina-cot-qwen-2.5-math-1.5b-lr-$lr-bz-$bz-max_length-$max_length-nproc_per_node-$nproc_per_node-micro_batch_size-$micro_batch_size-0916-convexity-1.0
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES torchrun --standalone --nnodes=1 --nproc_per_node=$nproc_per_node \
    ...
    trainer.objective_trans=convexity-1.0
