...
experiment_name=numina-cot-qwen-2.5-math-1.5b-lr-$lr-bz-$bz-max_length-$max_length-nproc_per_node-$nproc_per_node-micro_batch_size-$micro_batch_size-figure5-UnlikehoodBottom-K-5
save_path=./checkpoints/ablation/figure5/unlikehood_bottom/$experiment_name
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES torchrun --standalone --nnodes=1 --nproc_per_node=$nproc_per_node \
    ...
    trainer.objective_trans=UnlikehoodBottom-0.038074225187301636

PROMPT_TYPE="qwen-boxed"
MODEL_SAVE_NAME="qwen-2.5-math-1.5b"
MODEL_NAME_OR_PATH="$save_path/global_step_264"
OUTPUT_DIR="./results/ablation/figure5/unlikehood_bottom/$MODEL_SAVE_NAME/$experiment_name"
n_sampling=16
temperature=1
