...
experiment_name=openbookqa-qwen2.5-14b-lr-$lr-bz-$bz-max_length-$max_length-nproc_per_node-$nproc_per_node-micro_batch_size-$micro_batch_size-total_epochs-$TOTAL_EPOCHS-weight_decay-$weight_decay-oneAnswer-noise-0.3-original
