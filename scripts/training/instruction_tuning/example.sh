...
experiment_name=qwen2.5-7b-lr-$lr-bz-$bz-max_length-$max_length-nproc_per_node-$nproc_per_node-weight_decay-$weight_decay-micro_batch_size-$micro_batch_size-original
